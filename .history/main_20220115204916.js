...
function fetchNFTMetadata(NFTs) {
    for (let i = 0; i < Array.length; index++) {
        ...
        fetch("https://xupcupekjhqi.usemoralis.com:2053/server/functions/getNFT?_ApplicationId=rIDcnRq3Mps2hzqTbk0MLuhWhBp3sl9SvbWJcQfi" + id).then(res => { console.log(res) });
    }
}

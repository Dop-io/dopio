...
return CONTRACT_ADDRESS = "0x924a32A26dbD2e17d70f3cdC529f26BE5A0B6803"
...
function fetchNFTMetadata(NFTs) {
    ...
    for (let i = 0; i <= Array.length; i++) {
        ...
        promises.push(fetch("https://inkmvcv5mupx.usemoralis.com:2053/server/functions/getNFT?_ApplicationId=zN8sE9c1gNR7UQaHoNCrV3AryV2JouXgQ3FYDhgS&nftId=" + id)
            ...
            .then(res => {
                const options = { address: "0x924a32A26dbD2e17d70f3cdC529f26BE5A0B6803", token_id: "4", chain: "rinkeby" };

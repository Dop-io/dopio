import { exampleCat } from '../import-export/json-cat';
import { examplePunk } from '../import-export/json-punk';
import { examplePunk2 } from '../import-export/json-punk2';
...
export function initStorage(storage) {
  storage.setItem(
    STORAGE_KEY,
    JSON.stringify({
      stored: [examplePunk, examplePunk2], // Load an example project data by default
      current: 0
    })
  );
}
